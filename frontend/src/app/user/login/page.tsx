  ...
  return (
    <main className="max-w-md mx-auto px-4 py-12">
      ...
      <div className="text-center mt-4 text-sm">
        <a href="/user/forgot" className="text-yellow-600 hover:underline">Forgot password?</a> | <a href="/user/register" className="text-yellow-600 hover:underline">Register</a>
      </div>
    </main>
  );
} 